import { useSdk } from "../../helpers/sdk";
    ...
    expect(response.result["indexes"].sort()).toBe(["nyc-open-data"].sort());
      ...
      it('Infer <command> <body>', async () => {
        ...
        try {
          const { stdout } = await kourou("security:createUser", "{\"content\":{\"profileIds\":[\"default\"]}}",["--id","yagmur"]);
          response = stdout;
        } catch (error) {
          console.error(error);
          throw error;
      ...
      response = await sdk.query({"controller":"security","action":"getUser","_id":"yagmur"});
    });
    ...
    collection = "yellow-taxi";
        ...
        try {
          const { stdout } = await kourou("collection:exists", "nyc-open-data","yellow-taxi",[]);
          response = stdout;
        } catch (error) {
          console.error(error);
          throw error;
      ...
      it('Infer <command> <index> <collection> <body>', async () => {
        ...
        try {
          const { stdout } = await kourou("collection:update", "nyc-open-data","yellow-taxi","{ mappings: { dynamic: \"false\" } }",[]);
          response = stdout;
        } catch (error) {
          console.error(error);
          throw error;
    ...
    collection = "yellow-taxi";
      ...
      response = await sdk.query({"controller":"document","action":"create","index":"nyc-open-data","collection":"yellow-taxi","_id":"yagmur"});

        try {
          const { stdout } = await kourou("document:get", "nyc-open-data","yellow-taxi","yagmur",[]);
          response = stdout;
        } catch (error) {
          console.error(error);
          throw error;
    ...
    collection = "yellow-taxi";
        ...
        try {
          const { stdout } = await kourou("document:createOrReplace", "nyc-open-data","yellow-taxi","yagmur","{ \"city\": \"Antalya\" }",[]);
          response = stdout;
        } catch (error) {
          console.error(error);
          throw error;
      ...
      response = await sdk.query({"controller":"document","action":"get","index":"nyc-open-data","collection":"yellow-taxi","_id":"yagmur"});
